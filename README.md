...
- [2026/04/05] Released training and testing code.
...
- [DOM Testing Set](https://gateway.infinitescript.com/?f=DOM) – for benchmarking
- [DOM 3D Objects](https://gateway.infinitescript.com/?f=DOM-3D-Objects) – assets for data generation and benchmarking
- [DOM 3D Scenes](https://gateway.infinitescript.com/?f=DOM-3D-Scenes) – assets for data generation
...
- `-n 20`: run 20 episodes per environment
